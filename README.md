...
| System | Status |
|---|---|
| 2D Physics Engine (Java/JavaFX) | `[COMPILING...]` |
| OS design & low-level systems | `[DEBUGGING...]` |
| Hooked (2D platformer) | `[DREAMING...]` |
| Sleep schedule | `[FILE NOT FOUND]` |
...
<details>
<summary><sub>[ CLICK TO DECRYPT ]</sub></summary>
...
*The best projects start as ideas that won't let you sleep.*
